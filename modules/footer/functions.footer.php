...
if ( !function_exists( 'shoestrap_footer_css_custom' ) ) :
function shoestrap_footer_css_custom() {
...
add_action( 'shoestrap_after_footer', 'shoestrap_footer_icon_custom' );
