 ...
 */
if ( !function_exists( 'shoestrap_module_footer_custom_options' ) ) :
function shoestrap_module_footer_custom_options( $sections ) {
  ...
  $fields[] = array( 
    'title'       => __( 'Footer meow Background Color', 'shoestrap' ),
...
//remove_filter( 'redux-sections-shoestrap ,shoestrap_module_footer_options', 90 );
//add_filter( 'redux-sections-shoestrap,shoestrap_module_footer_custom_options', 90 );
remove_filter( 'redux/options/shoestrap/sections', 'shoestrap_module_footer_options', 90 );
add_filter( 'redux/options/shoestrap/sections', 'shoestrap_module_footer_custom_options', 90 );   
